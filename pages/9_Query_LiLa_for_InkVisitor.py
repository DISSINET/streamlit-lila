...
server_environment = platform.node()
if "GIDEON" in server_environment:
    sys.path.append('/home/user/hackathon2023-ink/')
elif "MILAREPA" in server_environment:
    sys.path.append('C:/Users/D/Documents/GitHub/hackathon2023-ink/')
elif "dissinet" in server_environment:
    import urllib.request
    proxy_support = urllib.request.ProxyHandler({'http': 'http://proxy.phil.muni.cz:3128', 'https': 'http://proxy.phil.muni.cz:3128'})
